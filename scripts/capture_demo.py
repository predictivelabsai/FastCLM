...
CAPTURES = (
    ...
    "18-legal-content-governance.png",
)
FRAMES = CAPTURES[1:10] + ("13-team.png", "14-settings-security.png", "15-approval-governance.png", "16-signature-execution.png", "17-notification-governance.png", "18-legal-content-governance.png")
...
def main() -> None:
    ...
    try:
        ...
        with sync_playwright() as playwright:
            ...
            page.goto(f"{BASE}/legal-content", wait_until="networkidle")
            shot(page, "18-legal-content-governance.png")
